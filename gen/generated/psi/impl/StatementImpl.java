...
public class StatementImpl extends ASTWrapperPsiElement implements Statement {
  ...
  public CompoundStatement getCompoundStatement() {
    return findChildByClass(CompoundStatement.class);
  }
  ...
  public IterationStatement getIterationStatement() {
    return findChildByClass(IterationStatement.class);
  }

  @Override
  @Nullable
  public JumpStatement getJumpStatement() {
    return findChildByClass(JumpStatement.class);
  }

  @Override
  @Nullable
  public SelectionStatement getSelectionStatement() {
    return findChildByClass(SelectionStatement.class);
  }
